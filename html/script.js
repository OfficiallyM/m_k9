    ...
    methods: {
        ...
        SetK9Name() {
            if (this.k9_name_form_valid) {
                axios.post("https://" + this.resource_name + "/updatename", {name: this.dog_name}).then(function(response) {
            ...
            this.ToggleNameChanger();
        },

        // Spawns K9 or Deletes K9
        SpawnK9() {
            if (!this.dog_model == "") {
                axios.post("https://" + this.resource_name + "/spawnk9", {model: this.dog_model}).then(function(response) {
                    //console.log(response);
                }).catch(function(error) {
                    console.log(error);
                });
        ...
        VehicleToggle() {
            axios.post("https://" + this.resource_name + "/vehicletoggle", {}).then(function(response) {
                //console.log(response);
            }).catch(function(error) {
                console.log(error);
            });
        ...
        VehicleSearch() {
            axios.post("https://" + this.resource_name + "/vehiclesearch", {}).then(function(response) {
                //console.log(response);
            }).catch(function(error) {
                console.log(error);
            })
        ...
        DogSit() {
            axios.post("https://" + this.resource_name + "/sit", {}).then(function(response) {
                //console.log(response);
            }).catch(function(error) {
                console.log(error);
            })
        ...
        DogLaydown() {
            axios.post("https://" + this.resource_name + "/laydown", {}).then(function(response) {
                //console.log(response);
            }).catch(function(error) {
                console.log(error);
            })
        ...
        SendCloseMenuPost() {
            axios.post("https://" + this.resource_name + "/closemenu", {}).then(function(response) {
                //console.log(response);
            }).catch(function(error) {
                console.log(error);
            });
